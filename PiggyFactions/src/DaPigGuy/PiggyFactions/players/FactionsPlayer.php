...
class FactionsPlayer
{
    ...
    private bool $canSeeBorders = false;
    ...
    public function canSeeBorders(): bool
    {
        return $this->canSeeBorders;
    }

    public function setCanSeeBorders(bool $value): void
    {
        $this->canSeeBorders = $value;
    }
